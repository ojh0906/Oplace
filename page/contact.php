    ...
    <article class="contact-form">
        <div class="max">
            ...
            <aside class="contact-container">
                <form name="contact_form" id="contact_form" method="post" action="contact-write.php">
                    <input type="hidden" name="writer_ip" value="<?= get_client_ip() ?>" />
                    <!-- 담당자 & 이메일 -->
                    ...
                    <div class="field select-wrap">
                        ...
                        <div class="select">
                            <input type="radio" id="field1" value="도시&지역" name="field" checked required>
                            <label for="field1">
                                <img class="off" src="<?php echo $site_url ?>/img/contact/offcheck.png" />
                                <img class="on" src="<?php echo $site_url ?>/img/contact/oncheck.png" />
                                <span>도시&지역</span>
                            </label>
                            <input type="radio" id="field2" value="주거&오피스" name="field">
                            <label for="field2">
                                <img class="off" src="<?php echo $site_url ?>/img/contact/offcheck.png" />
                                <img class="on" src="<?php echo $site_url ?>/img/contact/oncheck.png" />
                                <span>주거&오피스</span>
                            </label>
                            <input type="radio" id="field3" value="복합공간&리테일" name="field">
                            <label for="field3">
                                <img class="off" src="<?php echo $site_url ?>/img/contact/offcheck.png" />
                                <img class="on" src="<?php echo $site_url ?>/img/contact/oncheck.png" />
                                <span>복합공간&리테일</span>
                            </label>
                            <input type="radio" id="field4" value="리조트&테마파크" name="field">
                            <label for="field4">
                                <img class="off" src="<?php echo $site_url ?>/img/contact/offcheck.png" />
                                <img class="on" src="<?php echo $site_url ?>/img/contact/oncheck.png" />
                                <span>리조트&테마파크</span>
                            </label>
                            <input type="radio" id="field5" value="재생공간" name="field">
                            <label for="field5">
                                <img class="off" src="<?php echo $site_url ?>/img/contact/offcheck.png" />
                                <img class="on" src="<?php echo $site_url ?>/img/contact/oncheck.png" />
                                <span>재생공간</span>
                    ...
                    <div class="step select-wrap">
                        ...
                        <div class="select">
                            <input type="radio" id="step1" value="구상 단계" name="step" checked required>
                            <label for="step1">
                                <img class="off" src="<?php echo $site_url ?>/img/contact/offcheck.png" />
                                <img class="on" src="<?php echo $site_url ?>/img/contact/oncheck.png" />
                                <span>구상 단계</span>
                            </label>
                            <input type="radio" id="step2" value="진행 단계" name="step">
                            <label for="step2">
                                <img class="off" src="<?php echo $site_url ?>/img/contact/offcheck.png" />
                                <img class="on" src="<?php echo $site_url ?>/img/contact/oncheck.png" />
                                <span>진행 단계</span>
                            </label>
                            <input type="radio" id="step3" value="완료 단계" name="step">
                            <label for="step3">
                                <img class="off" src="<?php echo $site_url ?>/img/contact/offcheck.png" />
                                <img class="on" src="<?php echo $site_url ?>/img/contact/oncheck.png" />
                                <span>완료 단계</span>
