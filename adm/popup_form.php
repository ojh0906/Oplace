    ...
    <form name="popup_form" id="popup_form" method="post" enctype="multipart/form-data" action="./ajax/popup_setting.php">
        ...
        <div>
            <div class="input-wrap">
                ...
                <input type="text" name="start_date" id="start_date" class="form-control" value="<?= $start_date ?>" placeholder="ex) 2021-01-01 00:00:00" required>
                <label>
            ...
            <div class="input-wrap">
                ...
                <input type="text" name="end_date" id="end_date" class="form-control" value="<?= $end_date ?>" placeholder="ex) 2021-01-01 23:59:59" required>
                <label>
